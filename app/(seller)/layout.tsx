    ...
    <div className="flex h-screen bg-muted/30 overflow-hidden">
      ...
      <aside className="flex w-64 shrink-0 flex-col border-r border-border/40 bg-zinc-950 text-zinc-300 transition-all z-10">
        <Link href="/seller/dashboard" className="flex items-center gap-3 px-6 h-16 border-b border-white/10 hover:bg-white/5 transition-colors">
          ...
          <div>
            <p className="font-serif font-bold text-sm tracking-tight text-white">Shri Sameya Village</p>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-[200px] relative flex items-center justify-between px-8 bg-background border-b border-border/40 shrink-0 overflow-hidden">
           ...
           <h1 className="text-3xl font-bold tracking-tight relative z-10 text-foreground">Dashboard Overview</h1>
