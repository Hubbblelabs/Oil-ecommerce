...
| **`NEXT_PUBLIC_ENABLE_ADMIN_USERS`** | Admin platform directory, role escalations (promoting user to ADMIN), active state account blocks. | Removes "User Management" links in the Ops Sidebar. Blocks direct access to `/admin/users` panel. |
